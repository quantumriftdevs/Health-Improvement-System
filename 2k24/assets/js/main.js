...
document.addEventListener('DOMContentLoaded', () => {
     ...
     function addConsultations(e) {
          ...
          transaction.oncomplete = () => {
              // Include the date parameter in the URL
              window.location.href = 'booking-success.php?date=' + encodeURIComponent(date.value);
     ...
     function showConsultations() {
          ...
          objectStore.openCursor().onsuccess = function(e) {
               ...
               if(cursor) {
                    ...
                    cancelBtn.classList.add('btn', 'btn-Success');
                    cancelBtn.innerHTML = 'Accept';
